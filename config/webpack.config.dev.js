...
module.exports = {
        ...
        use: [
          {
            options: {
              ...
              baseConfig: {
                extends: [require.resolve('@ddeis/eslint-config-ngjs-app')],
              },
          ...
          // The preset includes JSX, Flow, and some ESnext features.
          {
            ...
            use: [
              ...
              },
              {
                ...
                options: {
                  presets: [require.resolve('@ddeis/babel-preset-ngjs-app')],
                  plugins: [],
  ...
  plugins: [
    ...
    //   { from: path.resolve(paths.appSrc, "img"), to: "static/img" },
    //   { from: path.resolve(paths.appSrc, "tr"), to: "static/i18n" },
    //   {
    //     from: path.resolve(
